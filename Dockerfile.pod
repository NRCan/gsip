## build
#--------------------------------------------------
# This is the podman version. Currently the only
# difference between this and the modified version
# on branch roman-makegsip-greatagain is that we do
# not load up a pile of NRCan Certs.
# The cert for Java/Maven seems to be required!
#
